...
describe("module template", function () {
    ...
    describe("didSetOptions", function () {
        ...
        it("should default extensionName to js", function () {
            Template.didSetOptions(options);
            expect(options.extensionName).toEqual("js");
        });
        it("should not modify the extensionName if it provided", function () {
            options.extensionName = "ext";
            Template.didSetOptions(options);
            expect(options.extensionName).toEqual("ext");
        });
    });
